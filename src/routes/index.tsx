      ...
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <Reveal delay={150}>
          <div className="mt-10 flex flex-col items-center gap-4">
            ...
            <a
              href="#"
              className="group inline-flex items-center gap-2 rounded-full bg-accent text-accent-foreground font-medium text-lg px-10 py-5 accent-glow hover:brightness-110 transition animate-puls[...]
            >
              Comprar ahora
